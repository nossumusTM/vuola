...
const CheckoutPage = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row max-w-screen-xl mx-auto px-4 py-10 gap-10">
      {/* LEFT SECTION */}
      <div className="w-full lg:w-2/3 bg-white rounded-lg shadow-md p-6 space-y-6">
  ...
  <p className="text-neutral-700 font-bold pt-3">Guests: {guests}</p>
</div>
        ...
        <div className="flex flex-row justify-between items-center">
            ...
            {cardInfo.method === 'card' && (
                ...
                <Image src="/images/visa.png" alt="Visa" className="h-4 w-auto object-contain" />
                <Image src="/images/mastercard.png" alt="MasterCard" className="h-5 w-auto object-contain" />
                <Image src="/images/AmericanExpress.png" alt="American Express" className="h-8 w-auto object-contain" />
                </div>
            )}
      ...
      {/* RIGHT SECTION */}
      <div className="w-full lg:w-1/3 bg-white rounded-lg shadow-md p-6 space-y-7 h-fit max-h-[700px]">
        {listingData && (
          <>
            {randomImage && (
            <Image
            ...
            <div className='flex flex-row gap-2'>
              <p className="text-neutral-600 pt-2.5">Hosted by</p>
              <p className="text-neutral-600 pt-2 text-xl font-bold">{listingData.user?.name || 'Anonymous'}</p>
              <Avatar src={listingData.user?.image} name={listingData.user?.name} />
            </div>
            <hr />
            <div className="text-md space-y-2">
              <div className="flex justify-between">
                <span>€{listingData.price} x {guests} guests</span>
